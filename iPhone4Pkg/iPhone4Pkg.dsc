...
################################################################################
[Defines]
  PLATFORM_NAME                  = iPhone4Pkg
  PLATFORM_GUID                  = 91fa6c28-33df-46ac-aee6-292d6811ea31
  PLATFORM_VERSION               = 0.1
  DSC_SPECIFICATION              = 0x00010005
  OUTPUT_DIRECTORY               = Build/iPhone4
  SUPPORTED_ARCHITECTURES        = ARM
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = iPhone4Pkg/iPhone4Pkg.fdf


[LibraryClasses.common]
  ArmLib|ArmPkg/Library/ArmLib/ArmV7/ArmV7Lib.inf
  ArmPlatformLib|iPhone4Pkg/Library/iPhone4CoreLib/iPhone4CoreLib.inf
...
!endif
  ...
  EfiResetSystemLib|iPhone4Pkg/Library/ResetSystemLib/ResetSystemLib.inf
...
#  PeCoffExtraActionLib|MdePkg/Library/BasePeCoffExtraActionLibNull/BasePeCoffExtraActionLibNull.inf
  ...
  iPhone4Lib|iPhone4Pkg/Library/iPhone4Lib/iPhone4Lib.inf
  SerialPortLib|iPhone4Pkg/Library/SerialPortLib/SerialPortLib.inf

  SerialPortExtLib|EmbeddedPkg/Library/TemplateSerialPortExtLib/TemplateSerialPortExtLib.inf 

  RealTimeClockLib|iPhone4Pkg/Library/RealTimeClockLib/RealTimeClockLib.inf
...
#
  ...
  TimerLib|iPhone4Pkg/Library/iPhone4TimerLib/iPhone4TimerLib.inf  
...
[PcdsFixedAtBuild.common]
  gArmPlatformTokenSpaceGuid.PcdFirmwareVendor|"iPhone 4"
  
  gEmbeddedTokenSpaceGuid.PcdEmbeddedPrompt|"iPhoneEdk2"
...
#
  ...
  gArmTokenSpaceGuid.PcdCpuVectorBaseAddress|0x42008000
  gArmTokenSpaceGuid.PcdCpuResetAddress|0x42008000
  
  gEmbeddedTokenSpaceGuid.PcdTimerPeriod|100000
  gEmbeddedTokenSpaceGuid.PcdEmbeddedPerformanceCounterPeriodInNanoseconds|1200
  gEmbeddedTokenSpaceGuid.PcdEmbeddedPerformanceCounterFrequencyInHz|24000000
  ...
  gArmPlatformTokenSpaceGuid.PcdPlatformBootTimeOut|65535
  ...
  # ARM OS Loader
  #
  gArmTokenSpaceGuid.PcdArmMachineType|6666
...
#  }
  ...
  iPhone4Pkg/InterruptDxe/InterruptDxe.inf
  iPhone4Pkg/TimerDxe/TimerDxe.inf 
  iPhone4Pkg/LcdGraphicsOutputDxe/LcdGraphicsOutputDxe.inf
